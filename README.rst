...
An `absolute maximum of 20 policies <https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html#reference_iam-quotas-entities>`_ is possible if you request a quota increase.
